(function(f, g, k) {
    var l = {
        init: function(b) {
            ...
            this.$elem.addClass("owl-carousel");
            this.$elem.addClass("owl-theme")
            ...
            if (!0 === this.options.pagination)
                this.owlControls = f('<div class="owl-controls"/>').toggleClass("clickable", true).appendTo(this.$elem);
            !0 === this.options.pagination && this.buildPagination();
            this.updateControls();
            var a = this, b, e = f(g).width();
            f(g).resize(function() {
                f(g).width() !== e && 
                (g.clearTimeout(b),
        ...
        updateItems: function() {
            var a = f(g).width();
            a > (1199 || this.orignalItems) && (this.options.items = this.orignalItems);
            a <= 1199 && (this.options.items = 4),
            a <= 979  && (this.options.items = 3),
            a <= 768 && (this.options.items = 2),
            a <= 479 && (this.options.items = 1);
        },
        ...
        calculateAll: function() {
            ...
            this.loops();
            this.options.items > this.itemsAmount ? this.maximumItem = 0 : (this.maximumItem = this.itemsAmount - this.options.items);
        },
        loops: function() {
            var b = 0, e;
        ...
        buildPagination: function() {
            this.paginationWrapper = f('<div class="owl-pagination"/>');
        ...
        jumpTo: function(a) {
            ...
            this.prevItem !== this.currentItem && (this.checkPagination(), this.eachMoveUpdate());
        },
